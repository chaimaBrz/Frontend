...
var NgxMasonryComponent = class {
  ...
  ngOnInit() {
    ...
    if (isPlatformBrowser(this.platformId)) {
      this.masonryInstance = new import_masonry_layout.default(this._element.nativeElement, this.options);
      ...
      for (const [index, item] of this.pendingItems.entries()) {
        if (item) {
          if (item.images && item.images.size === 0) {
            this.pendingItems[index] = void 0;
...
NgxMasonryComponent.ɵfac = function NgxMasonryComponent_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || NgxMasonryComponent)(ɵɵdirectiveInject(PLATFORM_ID), ɵɵdirectiveInject(ElementRef));
};
NgxMasonryComponent.ɵcmp = ɵɵdefineComponent({
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(NgxMasonryComponent, [{
    type: Component,
    args: [{
...
var NgxMasonryDirective = class {
  ...
  ngOnInit() {
    if (this.parent.options.animations !== void 0) {
...
NgxMasonryDirective.ɵfac = function NgxMasonryDirective_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || NgxMasonryDirective)(ɵɵdirectiveInject(ElementRef), ɵɵdirectiveInject(AnimationBuilder), ɵɵdirectiveInject(forwardRef(() => NgxMasonryComponent)), ɵɵdirectiveInject(Renderer2));
};
NgxMasonryDirective.ɵdir = ɵɵdefineDirective({
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(NgxMasonryDirective, [{
    type: Directive,
    args: [{
