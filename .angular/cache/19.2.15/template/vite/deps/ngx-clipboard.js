...
ClipboardService.ɵfac = function ClipboardService_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || ClipboardService)(ɵɵinject(NgZone), ɵɵinject(DOCUMENT), ɵɵinject(WINDOW, 8));
};
...
ClipboardDirective.ɵfac = function ClipboardDirective_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || ClipboardDirective)(ɵɵdirectiveInject(NgZone), ɵɵdirectiveInject(ElementRef), ɵɵdirectiveInject(Renderer2), ɵɵdirectiveInject(ClipboardService));
};
...
ClipboardIfSupportedDirective.ɵfac = function ClipboardIfSupportedDirective_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || ClipboardIfSupportedDirective)(ɵɵdirectiveInject(ClipboardService), ɵɵdirectiveInject(ViewContainerRef), ɵɵdirectiveInject(TemplateRef));
};
