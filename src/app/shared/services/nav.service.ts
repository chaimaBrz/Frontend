    ...
    // { path: "/file-manager", title: "File Manager", icon: "file", type: "link" },
    {
      ...
      children: [
       // { path: "/e-commerce/product", title: "Product", type: "link" },
        //{ path: "/e-commerce/product-page", title: "Equipement Page", type: "link" },
        { path: "/e-commerce/product-list", title: "Equipement List", type: "link" },
        { path: "/e-commerce/add-product", title: "Add Equipement", type: "link" },
       { path: "/e-commerce/payment-details", title: "Add ticket", type: "link" },
        { path: "/e-commerce/order-history", title: "UpDate", type: "link" },
